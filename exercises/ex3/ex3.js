...
With this you thrown away the buil-in .prototype that was there
and that has some things like the .constructor reference
Be careful
...
NotesManager.prototype.showHelp = function () {
    var self = this;    // usually code-smell, but this a tiny exception case
    self.$help.show();
    ...
    document.addEventListener("click", function __handler__(evt) {
        ...
        self.hideHelp();
        // With no 'self' solution ... we can do this
        // }.bind(this), true);    creates another problema, we have no reference to the hard bound function
        //imposible to remove a event handler function properly
    }, true);
};
